                ...
                {allDone ? (
                  ...
                  <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
                    ...
                    <div className="px-5 pt-5 pb-3 flex items-center justify-between">
                      <div>
                        <p className="text-[10px] uppercase tracking-[0.15em] font-semibold text-cowc-gray">What's next</p>
                        ...
                        return (
                          <button key={task.id} onClick={() => handleTaskToggle(task)}
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-cowc-dark truncate">{task.title}</p>
                              {task.due_date && (
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.24 }}
                ...
                {[
                  ...
                  <button key={label}
                    ...
                    className="bg-white rounded-2xl shadow-sm p-4 text-left hover:shadow-md transition-all active:scale-[0.97] group">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center mb-3"
                      style={{ background: softRing }}>
                      <Icon className="w-4.5 h-4.5" style={{ color: accent }} />
                    </div>
                    <p className="text-sm font-semibold text-cowc-dark leading-tight">{label}</p>
                    <p className="text-[11px] text-cowc-gray mt-0.5">{sub}</p>
                  </button>
                ))}
              </motion.div>
              ...
              {coordinator && (
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28 }}
                  ...
                  <div className="px-5 pt-5 pb-4">
                    <p className="text-[10px] uppercase tracking-[0.15em] font-semibold text-cowc-gray mb-3">Your coordinator</p>
              ...
              {myReservations.length > 0 && (
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.32 }}
                  ...
                  <div className="px-5 pt-5 pb-1 flex items-center justify-between">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.15em] font-semibold text-cowc-gray">Your rentals</p>
                      <p className="font-serif text-cowc-dark text-lg leading-tight mt-0.5">
